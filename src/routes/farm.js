...
function shopPage(message) {
  return `<!doctype html><meta charset="utf-8"><title>農場商店</title><style>body{font:18px system-ui;max-width:42rem;margin:4rem auto;padding:0 1rem}a{color:#075985}</style><h1>農場商店</h1><p>${message}</p><p><a href="/">回到遊戲</a></p><script>window.opener?.postMessage({type:'farmer-purchase-complete'}, location.origin)</script>`;
}
